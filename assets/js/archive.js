...
<<<<<<< HEAD
                ...
                <div class="card-meta">
                    <span class="date"><i class="fa-regular fa-calendar"></i> Date Archived: ${new Date(item.date).toLocaleDateString()}</span>
                    <span class="author"><i class="fa-solid fa-thumbtack"></i> ${metaInfo}</span>
                </div>
